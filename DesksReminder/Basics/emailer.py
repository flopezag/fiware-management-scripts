...
from DesksReminder.Basics.settings import ACCESS_TOKEN, REFRESH_TOKEN, CLIENT_ID, CLIENT_SECRET, SENDER
from DesksReminder.Basics.constants import SIGNATURE, GOOGLE_ACCOUNTS_BASE_URL
